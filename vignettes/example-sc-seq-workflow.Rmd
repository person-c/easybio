...
We begin by feeding the cluster markers (from `Seurat::FindAllMarkers`) into `matchCellMarker2()`. This function compares our markers against the CellMarker 3.0 database and returns a ranked list of potential cell types for each cluster.
